...
public interface BaseDao<T, PK extends Serializable> {
     ...
     * @param oldValue
     *            修改后的属性值
     * @return <tt>true</tt> 新修改的值与原来值相等<br/> <tt>false</tt> 新修改的值与原来值不相等<br/>
     */
    ...
    /**
     * 根据Pager和DetachedCriteria对象进行查询(提供分页、查找和排序功能).
     * 
     * @param pager
     *            Pager对象
     * @return Pager对象
     ...
     *            统计语句
     * @param Map
     *            <String, Object> params 名称占位符的名称与数据集
     * @return List
     */
